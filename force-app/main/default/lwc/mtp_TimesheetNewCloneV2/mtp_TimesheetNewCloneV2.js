...
export default class mtp_TimesheetNewCloneV2 extends NavigationMixin(LightningElement) {
    ...
    handleInputChange(event){
        ...
        console.log(fieldId+' ==> '+this.template.querySelector('[data-id="'+fieldId+'"]').value);
    ...
    createTimesheet(event){
        ...
        console.log('Start_Time__c ==> '+this.convetToMilliseconds(this.timeSheetObj['Start_Time__c']));
        console.log('End_Time__c ==> '+this.convetToMilliseconds(this.timeSheetObj['End_Time__c']));
